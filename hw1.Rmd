...
3. Write a paragraph to introduce yourself. Set your name in bold font and your major in italic. 
    ...
    Answer: Hello! My name is **Austin Nebel** and I am a senior in *software engineering*. 
...
4. Write a paragraph describing a job that you think is related to data science. Include a hyperlink and an image. Make sure your answer is in a nice format to read. 
    ...
    Answer: A job related to data science would be the development of AI for speech processing. Google has its own [speech-to-text demo](https://cloud.google.com/speech-to-text) that can be used for free.
    
    ![](https://miro.medium.com/max/556/1*SvB6VPtPaU70dskNNVxLXw.png)
  
5. What data topic will you be most interested in? (Optional) Provide a source of such dataset if you have.

    Answer: When it comes to data science I have a great interest in machine learning and other AI technology.
